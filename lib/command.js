...
Command.prototype.parseExpectedArgs = function (args) {
  ...
  args.forEach(function (arg) {
    ...
    switch (arg[0]) {
      case '<':
        this._args.push({ required: true, name: arg.slice(1, -1) });
        return;
      case '[':
        this._args.push({ required: false, name: arg.slice(1, -1) });
        return;
    }
  }, this);
  return this;
...
Command.prototype.action = function (fn) {
  ...
  function actionHandler(args, unknown) {
    ...
    self._args.forEach(function (arg, i) {
      if (arg.required && typeof args[i] === 'undefined') {
  ...
  for (var i = 0; i < len; ++i) {
    ...
    if (option) {
      ...
      // optional arg
        ...
        arg = argv[i + 1];
        if (typeof arg === 'undefined' || ('-' === arg[0] && '-' !== arg)) {
          arg = null;
        } else {
          ++i;
        }
